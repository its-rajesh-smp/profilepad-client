      ...
      <section className="flex h-screen flex-col gap-6 p-6 pt-0">
        ...
        <div className="flex h-full w-full gap-5">
          ...
          <div
            ...
            className="relative flex h-full w-full flex-col items-center justify-center rounded-3xl bg-zinc-800 text-white"
          >
            <SpotlightEffect className="left-0 top-0" fill="white" />
            <h2 className="text-4xl font-thin">Connect</h2>
          ...
          {/* Right side */}
          <div className="h-full w-full bg-blue-500">sdfsdfsdfsdfsf</div>
        </div>
      </section>
    </div>
  );
